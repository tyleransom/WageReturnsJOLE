...
set more off
capture log close
log using "y79_create_geocode_full_cohorts.log", replace
...
use id year month interview_date missInt using y79_all_full_cohorts.dta, clear
sort id year
...
save y79_geocode2_full_cohorts, replace
...
compress
save y79_geocode3_full_cohorts, replace
