function [finaloutcome] = margcalcn(gammaM0)

global argmarg samepeople sameweights IdrawWeightsM IgammaM regim
...
%finaloutcome1 = margcalcp(regim);
finaloutcome1 = jacobianest(@(x) margcalcp(x),regim);
