...
{
	variableMainAttr (const struct prok3Input* inputs, unsigned v_index)
	{
...
{
	variableCovAttr (const struct prok3Input* inputs, unsigned v_data,unsigned i_var)
	{
...
{
	variableLIterVAttr (const struct prok3Input* inputs, unsigned v_data,unsigned i_var,unsigned ii,unsigned i_obs, unsigned i_coeff)
	{
...
{
	variableInclVAttrPlus (const struct prok3Input* inputs, unsigned v_data,unsigned i_var,unsigned nin)
	{
...
unsigned variableObsRegrAttr (const struct prok3Input* inputs, unsigned v_data,unsigned i_var) /* getting the index of the first regressors */
{     
...
unsigned variableNIterVAttr (const struct prok3Input* inputs, unsigned v_data,unsigned i_var) /* getting the number of iteration-specific missing variables */
{
...
unsigned variableNInclAttr (const struct prok3Input* inputs, unsigned v_data,unsigned i_var) /* getting the number of variables in which the outcome variable is a regressor */
{
...
unsigned variableInclVAttr (const struct prok3Input* inputs, unsigned v_data,unsigned i_var,unsigned nin) /* getting the index of the location in which the outcome variable is a regressor */
{
		unsigned outpos = inputs->indInclOutcReg[i_var]+nin; /*index showing the location of the data for position as a regressor */
		unsigned bk_pos = v_data + outpos; /* point where data for the outcome in the data starts */
		unsigned outpo = inputs->xxmat[bk_pos]; /* position as a regressor */
