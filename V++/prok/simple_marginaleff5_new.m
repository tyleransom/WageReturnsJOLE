...
% If doing higher order mfx, add higher-order indices onto inter vectors
interoneMA  = [interoneMA  oneMA ];
intertwoMA  = [intertwoMA  twoMA ];
interbothMA = [interbothMA bothMA];
intermultMA = [intermultMA multMA];
