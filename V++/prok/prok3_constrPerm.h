void constructResidual(const struct prok3Input* inputs,
...
void constructPermMissCont(const struct prok3Input* inputs,
										const struct variableMainAttr& vMA, 
										std::vector<double>& in_out_xxmat_aux_m)
{
...
void constructPermMissDisc(const struct prok3Input* inputs,
										const struct variableMainAttr& vMA, 
										std::vector<double>& out_aux_obs_lin,
										std::vector<double>& in_out_xxmat_aux_m)
{										
