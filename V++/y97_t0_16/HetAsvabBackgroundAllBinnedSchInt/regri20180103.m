...
GroupN=round(N/13); %for speed of calculations
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
T=156;
holder                  = 150; % placeholder for varnumber sequence
...
name.schoolOnlyBin1     = 88 ;
name.schoolOnlyBin2     = 89 ;
name.schoolOnlyBin3     = 90 ;
name.schoolOnlyBin4     = 91 ;
name.schoolOnlyBin5     = 92 ;
name.schoolOnlyBin6     = 93 ;
name.schoolOnlyBin7     = 94 ;
name.schoolOnlyBin8     = 95 ;
name.schoolOnlyBin9     = 96 ;
name.workK12Bin1        = 97 ;
name.workK12Bin2        = 98 ;
name.workK12Bin3        = 99 ;
name.workK12Bin4        = 100;
name.workK12Bin5        = 101;
name.workK12Bin6        = 102;
name.workK12Bin7        = 103;
name.workK12Bin8        = 104;
name.workK12Bin9        = 105;
name.workCollegeBin1    = 106;
name.workCollegeBin2    = 107;
name.workCollegeBin3    = 108;
name.workCollegeBin4    = 109;
name.workCollegeBin5    = 110;
name.workCollegeBin6    = 111;
name.workCollegeBin7    = 112;
name.workCollegeBin8    = 113;
name.workCollegeBin9    = 114;
name.workPTonlyBin1     = 115;
name.workPTonlyBin2     = 116;
name.workPTonlyBin3     = 117;
name.workPTonlyBin4     = 118;
name.workPTonlyBin5     = 119;
name.workPTonlyBin6     = 120;
name.workPTonlyBin7     = 121;
name.workPTonlyBin8     = 122;
name.workPTonlyBin9     = 123;
name.workFTonlyBin1     = 124;
name.workFTonlyBin2     = 125;
name.workFTonlyBin3     = 126;
name.workFTonlyBin4     = 127;
name.workFTonlyBin5     = 128;
name.workFTonlyBin6     = 129;
name.workFTonlyBin7     = 130;
name.workFTonlyBin8     = 131;
name.workFTonlyBin9     = 132;
name.militaryBin1       = 133;
name.militaryBin2       = 134;
name.militaryBin3       = 135;
name.militaryBin4       = 136;
name.militaryBin5       = 137;
name.otherBin1          = 138;
name.otherBin2          = 139;
name.otherBin3          = 140;
name.otherBin4          = 141;
...
for t=1:T;t
	...
	varnumber=t*holder+name.hispanic; eval(['varval' num2str(varnumber) ' = hispanic(:,:,1);']); namevar{varnumber,1}='hispanic'; stvar(1,discrete,varnumber)=1; %97 uses a restriction on the non-interacted dummy in military option of choice1
		rownumber= 1; stvar(rownumber,present  ,varnumber)=1; stvar(rownumber,idmodel  ,varnumber)=t*holder+name.Choices1;
	...
	varnumber=t*holder+name.born1980; eval(['varval' num2str(varnumber) ' = born1980(:,:,1);']); namevar{varnumber,1}='born1980'; stvar(1,discrete,varnumber)=1;
		rownumber=1; stvar(rownumber,present  ,varnumber)=1; stvar(rownumber,idmodel  ,varnumber)=t*holder+name.Choices1;
	...
	varnumber=t*holder+name.born1981; eval(['varval' num2str(varnumber) ' = born1981(:,:,1);']); namevar{varnumber,1}='born1981'; stvar(1,discrete,varnumber)=1;
		rownumber=1; stvar(rownumber,present  ,varnumber)=1; stvar(rownumber,idmodel  ,varnumber)=t*holder+name.Choices1;
		rownumber=2; stvar(rownumber,present  ,varnumber)=1; stvar(rownumber,idmodel  ,varnumber)=t*holder+name.Choices2;
		rownumber=3; stvar(rownumber,present  ,varnumber)=1; stvar(rownumber,idmodel  ,varnumber)=t*holder+name.Choices3;
		rownumber=4; stvar(rownumber,present  ,varnumber)=1; stvar(rownumber,idmodel  ,varnumber)=t*holder+name.Wage1;
	...
	varnumber=t*holder+name.born1982; eval(['varval' num2str(varnumber) ' = born1982(:,:,1);']); namevar{varnumber,1}='born1982'; stvar(1,discrete,varnumber)=1; %97 uses a restriction in military option of choice1
		rownumber=1; stvar(rownumber,present  ,varnumber)=1; stvar(rownumber,idmodel  ,varnumber)=t*holder+name.Choices1;
			% if t==1; a=4;b=4;restricter; end;
		rownumber=2; stvar(rownumber,present  ,varnumber)=1; stvar(rownumber,idmodel  ,varnumber)=t*holder+name.Choices2;
		rownumber=3; stvar(rownumber,present  ,varnumber)=1; stvar(rownumber,idmodel  ,varnumber)=t*holder+name.Choices3;
	...
	varnumber=t*holder+name.born1983; eval(['varval' num2str(varnumber) ' = born1983(:,:,1);']); namevar{varnumber,1}='born1983'; stvar(1,discrete,varnumber)=1;
		rownumber=1; stvar(rownumber,present  ,varnumber)=1; stvar(rownumber,idmodel  ,varnumber)=t*holder+name.Choices1;
		rownumber=2; stvar(rownumber,present  ,varnumber)=1; stvar(rownumber,idmodel  ,varnumber)=t*holder+name.Choices2;
		rownumber=3; stvar(rownumber,present  ,varnumber)=1; stvar(rownumber,idmodel  ,varnumber)=t*holder+name.Choices3;
		rownumber=4; stvar(rownumber,present  ,varnumber)=1; stvar(rownumber,idmodel  ,varnumber)=t*holder+name.Wage1;
	...
	varnumber=t*holder+name.foreignBorn; eval(['varval' num2str(varnumber) ' = foreignBorn(:,:,1);']); namevar{varnumber,1}='foreignBorn'; stvar(1,discrete,varnumber)=1; %97 uses a restriction in military option of choice1 and choice3 
		rownumber=1; stvar(rownumber,present  ,varnumber)=1; stvar(rownumber,idmodel  ,varnumber)=t*holder+name.Choices1;
			if t==1; a=4;b=4;restricter; end;
		rownumber=2; stvar(rownumber,present  ,varnumber)=1; stvar(rownumber,idmodel  ,varnumber)=t*holder+name.Choices2;
		rownumber=3; stvar(rownumber,present  ,varnumber)=1; stvar(rownumber,idmodel  ,varnumber)=t*holder+name.Choices3;
	...
	varnumber=t*holder+name.hgcMoth; eval(['varval' num2str(varnumber) ' = hgcMoth       (:,:,1);']); namevar{varnumber,1}='hgcMoth';
		...
		rownumber=3; stvar(rownumber,present  ,varnumber)=1; stvar(rownumber,idmodel  ,varnumber)=t*holder+name.Choices3;
			if t==1; a=4;b=4;restricter; end;
		if t==1 
			rownumber=4; stvar(rownumber,present  ,varnumber)=1; stvar(rownumber,idmodel  ,varnumber)=t*holder+name.asvabAR;
			rownumber=5; stvar(rownumber,present  ,varnumber)=1; stvar(rownumber,idmodel  ,varnumber)=t*holder+name.asvabCS;
			rownumber=6; stvar(rownumber,present  ,varnumber)=1; stvar(rownumber,idmodel  ,varnumber)=t*holder+name.asvabMK;
			rownumber=7; stvar(rownumber,present  ,varnumber)=1; stvar(rownumber,idmodel  ,varnumber)=t*holder+name.asvabNO;
			rownumber=8; stvar(rownumber,present  ,varnumber)=1; stvar(rownumber,idmodel  ,varnumber)=t*holder+name.asvabPC;
			rownumber=9; stvar(rownumber,present  ,varnumber)=1; stvar(rownumber,idmodel  ,varnumber)=t*holder+name.asvabWK;
		end
		stvar(1,numrows,varnumber)=rownumber;
	...
	varnumber=t*holder+name.workCollegeBin9; eval(['varval' num2str(varnumber) ' = [workColleget(:,:,t)>=5                       ];']); eval(['msvar'  num2str(varnumber) ' = 2*(missedInt(:,1,t)==0)-1;']); namevar{varnumber,1}=strcat('workCollegeBin9',num2str(t)); %experience at the beginning of t - from the data set
		...
		rownumber=3;  stvar(rownumber,present   ,varnumber)=1; stvar(rownumber,idmodel   ,varnumber)=t*holder+name.Choices2; 
			if t==1;
				...
				a=4;b=4;d=rownumber;c=t*holder+name.workCollegeBin8;restricterType1;
			end;
		rownumber=4;  stvar(rownumber,present   ,varnumber)=1; stvar(rownumber,idmodel   ,varnumber)=t*holder+name.Choices3; 
			if t==1; a=4;b=4;restricter; end;
		stvar(1,numrows,varnumber)=rownumber;
	...
	varnumber=t*holder+name.workPTonlyBin7; eval(['varval' num2str(varnumber) ' = [workPTonlyt(:,:,t)>=(6/3) & workPTonlyt(:,:,t)<(7/3)];']); eval(['msvar'  num2str(varnumber) ' = 2*(missedInt(:,1,t)==0)-1;']); namevar{varnumber,1}=strcat('workPTonlyBin7',num2str(t)); %experience at the beginning of t - from the data set
		...
		rownumber=2;  stvar(rownumber,present   ,varnumber)=1; stvar(rownumber,idmodel   ,varnumber)=t*holder+name.Choices1; 
			if t==1;
				...
				a=6;b=6;d=rownumber;c=t*holder+name.workPTonlyBin6;restricterType1;
			end;
		rownumber=3;  stvar(rownumber,present   ,varnumber)=1; stvar(rownumber,idmodel   ,varnumber)=t*holder+name.Choices2; 
		rownumber=4;  stvar(rownumber,present   ,varnumber)=1; stvar(rownumber,idmodel   ,varnumber)=t*holder+name.Choices3; 
			if t==1; a=4;b=4;restricter; end;
	...
	varnumber=t*holder+name.workPTonlyBin8; eval(['varval' num2str(varnumber) ' = [workPTonlyt(:,:,t)>=(7/3) & workPTonlyt(:,:,t)<(8/3)];']); eval(['msvar'  num2str(varnumber) ' = 2*(missedInt(:,1,t)==0)-1;']); namevar{varnumber,1}=strcat('workPTonlyBin8',num2str(t)); %experience at the beginning of t - from the data set
		...
		rownumber=3;  stvar(rownumber,present   ,varnumber)=1; stvar(rownumber,idmodel   ,varnumber)=t*holder+name.Choices2; 
			if t==1;
				stvar(rownumber,numberrest,varnumber)=1;jj=0;
				a=4;b=4;d=rownumber;c=t*holder+name.workPTonlyBin7;restricterType1;
			end;
		rownumber=4;  stvar(rownumber,present   ,varnumber)=1; stvar(rownumber,idmodel   ,varnumber)=t*holder+name.Choices3; 
			if t==1; a=4;b=4;restricter; end;
		stvar(1,numrows,varnumber)=rownumber;
	...
	varnumber=t*holder+name.workFTonlyBin5; eval(['varval' num2str(varnumber) ' = [workFTonlyt(:,:,t)>=4 & workFTonlyt(:,:,t)<5];']); eval(['msvar'  num2str(varnumber) ' = 2*(missedInt(:,1,t)==0)-1;']); namevar{varnumber,1}=strcat('workFTonlyBin5',num2str(t)); %experience at the beginning of t - from the data set
		...
		rownumber=3;  stvar(rownumber,present   ,varnumber)=1; stvar(rownumber,idmodel   ,varnumber)=t*holder+name.Choices2; 
			if t==1;
				stvar(rownumber,numberrest,varnumber)=1;jj=0;
				a=6;b=6;d=rownumber;c=t*holder+name.workFTonlyBin4;restricterType1;
			end;
		rownumber=4;  stvar(rownumber,present   ,varnumber)=1; stvar(rownumber,idmodel   ,varnumber)=t*holder+name.Choices3; 
			if t==1; a=4;b=4;restricter; end;
		stvar(1,numrows,varnumber)=rownumber;
	varnumber=t*holder+name.workFTonlyBin6; eval(['varval' num2str(varnumber) ' = [workFTonlyt(:,:,t)>=5 & workFTonlyt(:,:,t)<6];']); eval(['msvar'  num2str(varnumber) ' = 2*(missedInt(:,1,t)==0)-1;']); namevar{varnumber,1}=strcat('workFTonlyBin6',num2str(t)); %experience at the beginning of t - from the data set
		...
		rownumber=4;  stvar(rownumber,present   ,varnumber)=1; stvar(rownumber,idmodel   ,varnumber)=t*holder+name.Choices3; 
			if t==1;
				stvar(rownumber,numberrest,varnumber)=4;jj=0;
				a=4;b=4;restricterType0;
				a=1;b=1;d=rownumber;c=t*holder+name.workFTonlyBin5;restricterType1;
				a=3;b=3;d=rownumber;c=t*holder+name.workFTonlyBin5;restricterType1;
				a=5;b=5;d=rownumber;c=t*holder+name.workFTonlyBin5;restricterType1;
			end;
		stvar(1,numrows,varnumber)=rownumber;
	varnumber=t*holder+name.workFTonlyBin7; eval(['varval' num2str(varnumber) ' = [workFTonlyt(:,:,t)>=6 & workFTonlyt(:,:,t)<7];']); eval(['msvar'  num2str(varnumber) ' = 2*(missedInt(:,1,t)==0)-1;']); namevar{varnumber,1}=strcat('workFTonlyBin7',num2str(t)); %experience at the beginning of t - from the data set
		...
		rownumber=2;  stvar(rownumber,present   ,varnumber)=1; stvar(rownumber,idmodel   ,varnumber)=t*holder+name.Choices1; 
			if t==1;
				...
				a=6;b=6;d=rownumber;c=t*holder+name.workFTonlyBin6;restricterType1;
			end;
		rownumber=3;  stvar(rownumber,present   ,varnumber)=1; stvar(rownumber,idmodel   ,varnumber)=t*holder+name.Choices2; 
			if t==1;
				stvar(rownumber,numberrest,varnumber)=2;jj=0;
				a=4;b=4;d=rownumber;c=t*holder+name.workFTonlyBin6;restricterType1;
				a=6;b=6;d=rownumber;c=t*holder+name.workFTonlyBin4;restricterType1;
			end;
		rownumber=4;  stvar(rownumber,present   ,varnumber)=1; stvar(rownumber,idmodel   ,varnumber)=t*holder+name.Choices3; 
			if t==1;
	...
	varnumber=t*holder+name.otherBin6; eval(['varval' num2str(varnumber) ' = [othert(:,:,t)>=2 & othert(:,:,t)<3];']); eval(['msvar'  num2str(varnumber) ' = 2*(missedInt(:,1,t)==0)-1;']); namevar{varnumber,1}=strcat('otherBin6',num2str(t)); %experience at the beginning of t - from the data set
		...
		rownumber=4;  stvar(rownumber,present   ,varnumber)=1; stvar(rownumber,idmodel   ,varnumber)=t*holder+name.Choices3; 
			if t==1;
				stvar(rownumber,numberrest,varnumber)=2;jj=0;
				a=4;b=4;restricterType0;
				a=2;b=2;d=rownumber;c=t*holder+name.otherBin5;restricterType1;
			end;
		stvar(1,numrows,varnumber)=rownumber;
	...
	varnumber=t*holder+name.otherBin9; eval(['varval' num2str(varnumber) ' = [othert(:,:,t)>=5                       ];']); eval(['msvar'  num2str(varnumber) ' = 2*(missedInt(:,1,t)==0)-1;']); namevar{varnumber,1}=strcat('otherBin9',num2str(t)); %experience at the beginning of t - from the data set
		...
		rownumber=2;  stvar(rownumber,present   ,varnumber)=1; stvar(rownumber,idmodel   ,varnumber)=t*holder+name.Choices1; 
			if t==1;
				stvar(rownumber,numberrest,varnumber)=2;jj=0;
				a=4;b=4;restricterType0;
				a=1;b=1;d=rownumber;c=t*holder+name.otherBin8;restricterType1;
			end;
		rownumber=3;  stvar(rownumber,present   ,varnumber)=1; stvar(rownumber,idmodel   ,varnumber)=t*holder+name.Choices2; 
			if t==1;
				stvar(rownumber,numberrest,varnumber)=2;jj=0;
