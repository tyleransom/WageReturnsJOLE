clear all;
delete opt_routf3ga.diary;
diary  opt_routf3ga.diary;
vladppadd
tic
...
% Import starting values: use results from estimation with instruments
load ../Het1Load10/results gamma_final

% Draw new starting values from uniform distribution between the two gamma0's
instrflag = [31:33 109:111 187:189 265:267 343:345 421:423 503:505 600:602 697:699 794:796 891:893 988:990 1085:1087 1182:1184 1279:1281 1376:1378 1473:1475]; % for 97
gamma0 = gamma_final;
gamma0(instrflag) = [];
...
% nessie = jacobianest(@(x) prok3x_cpp_ofdd(x),gamma_f); %estimation of the hessian from the gradients
toc;tic;
...
toc;
save results;
dlmwrite ('results.csv',[[gamma_final sErrors1]; [-fval NaN]]);
diary off;
